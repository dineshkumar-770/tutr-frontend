...
abstract class AppColors {
  ...
  static Color textfieldbackgroundColor = Color(0xffF1F4F5);

  static Color primaryButtonColor = Colors.black;
  static Color amber = Colors.amber;
  static Color green = Colors.green;
  static Color lightGrey = Color(0xffECEDF2);
  ...
  static Color progressPrimaryColor = Color(0xff4895EF);
  static Color progressSecondaryColor = Color(0xff12086F);
