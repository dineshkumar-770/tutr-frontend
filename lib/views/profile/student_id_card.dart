...
class StudentIdCard extends StatelessWidget {
  const StudentIdCard({
    super.key,
    required this.studentIdCardArgs,
  });
  final StudentIdCardArgs studentIdCardArgs;
                ...
                children: [
                  Column(
                    children: [
                      ...
                      // Name and Role
                      Text(
                        studentIdCardArgs.name.toUpperCase(),
                        style: TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 20,
                          letterSpacing: 1,
                      ...
                      Text(
                        "CLASS ${studentIdCardArgs.className}",
                        style: TextStyle(
                          fontSize: 16,
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            IDDetailRow(title: "ID NO", value: studentIdCardArgs.id),
                            IDDetailRow(title: "Emergency Contact", value: studentIdCardArgs.parentsContact),
                            IDDetailRow(title: "Phone", value: studentIdCardArgs.phone),
                            IDDetailRow(title: "Email", value: studentIdCardArgs.email),
                            IDDetailRow(title: "Address", value: studentIdCardArgs.address),
                            IDDetailRow(
                                title: "Joined At",
                                value: locatorDI<Helper>().formatTimeFronUnixTimeStamp(studentIdCardArgs.joinedAt)),
                          ],
                        ),
                      ),
                      ...
                      //     child: SfBarcodeGenerator(value: studentIdCardArgs.id),
                      //   ),
                      // ),
                    ...
                    child: Center(
                      child: Container(
                        ...
                        child: CircleAvatar(
                          ...
                          backgroundImage: studentIdCardArgs.imageUrl.isEmpty
                              ? null
                              : const NetworkImage(
                                  'https://randomuser.me/api/portraits/men/75.jpg',
                                ),
                          child: studentIdCardArgs.imageUrl.isEmpty
                              ? Center(
                                  child: Icon(
                                    Icons.person,
                                    size: 40.0.adptSP,
