          ...
          builder: (context, state) {
            switch (state.navBarItems) {
              ...
              case NavBarItems.TuTrREELS:
                return Center(
                  child: Text("TuTr REELS Comming soon!"),
                );
            }
          },
        ),
        ...
        builder: (context, state) {
          return BottomNavigationBar(
              ...
              onTap: (value) {
                ...
                context.read<RootScreenDartCubit>().switchBottomBar(value);
              },
              items: [
                BottomNavigationBarItem(
                    ...
                    tooltip: "Home"),
                BottomNavigationBarItem(
                    icon: Icon(Icons.group), label: "Create Group", activeIcon: Icon(Icons.group_rounded)),
                BottomNavigationBarItem(
